...
function Technology() {
  ...
  return (
    <section className="mx-auto w-[calc(100%-48px)] max-w-[1248px] py-16 max-[520px]:w-[calc(100%-32px)] max-[520px]:py-12" id="technologies" aria-labelledby="technologies-heading">
      <div className="mb-9">
        <h2 className="m-0 text-[34px] font-extrabold tracking-[-.045em] text-[#121a2d] max-[520px]:text-[29px]" id="technologies-heading">
          Explore the <span className="bg-gradient-to-r from-[#ed2d91] to-[#8342ed] bg-clip-text text-transparent">Technologies</span>
        </h2>
